...
const Carousel = () => {
  const slides = [
    ...
    {
      url: "https://images.unsplash.com/photo-1481819167214-0427aac02394?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1146&q=80",
    ...
    {
      url: "https://images.unsplash.com/photo-1570368336224-455084c1fb31?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80",
      title: "Som Tam",
    ...
    {
      url: "https://images.unsplash.com/photo-1628432017781-49e012d769b3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1171&q=80",
      title: "Tom Yum Soup",
    ...
    <div className="md:max-w-[1400px] h-[500px] w-full m-auto pb-16 relative group">
      ...
      >
        <div className="absolute left-0 top-24 md:top-0 md:h-[420px] flex flex-col justify-center px-5 md:px-10 md:w-1/2 md:text-justify">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">{slides[currentIndex].title}</h2>
          <p className="text-white">{slides[currentIndex].text.length < 300 ? <p>{slides[currentIndex].text}</p> : <p>{slides[currentIndex].text.slice(0,300)}...</p>}</p>
        </div>
      </div>
      {/* Left Arrow */}
